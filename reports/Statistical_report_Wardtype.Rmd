...
NT-proBNP is considered below median if it is below the 50 percentile within 
each EF (p, mr, r) group, and above median if it is above or equal to the 50 percentile. 
...
Summary of follow-up time (years):
```{r}
summary(wdata$timeTodeath) / 365.25
```
...
between ward and the respective outcomes. Data were censored at 2016-12-31 
